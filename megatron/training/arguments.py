...
def validate_args(args, defaults={}):
    ...
    if args.perform_rl_step:
        ...
        if args.rl_submit_rollouts_individually:
            assert args.rl_partial_rollouts, \
                "--rl-submit-rollouts-individually requires --rl-partial-rollouts."
...
def _add_rl_args(parser):
    ...
    group.add_argument('--rl-num-parallel-generations', type=int, default=None,
                       help='Number of rollouts being generated by the inference engine simultaneously. '
                            ...
                            '--rl-submit-rollouts-individually is set. '
    ...
    group.add_argument('--rl-submit-rollouts-individually', action='store_true',
                       help='Submit individual rollouts independently while still yielding '
                            'complete rollout groups to training. Requires --rl-partial-rollouts.')
